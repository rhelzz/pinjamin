<x-app-layout>
    <x-slot name="pageTitle">Data Alat</x-slot>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150 {{ $alat->stok == 0 ? 'bg-red-50/30' : '' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <form action="{{ route('admin.alat.destroy', $alat) }}" method="POST" class="inline" data-confirm="Yakin ingin menghapus alat ini? Data peminjaman terkait akan terpengaruh." data-confirm-title="Konfirmasi Hapus Alat" data-confirm-type="danger">
                                                @csrf
                                                @method('DELETE')

<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">Tambah User</h2>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-indigo-50 to-white border-b border-gray-200 px-6 py-5">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Lengkapi data user dengan benar</p>
                </div>
                ...
                <form action="{{ route('admin.user.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" 
                                    class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all @error('name') border-red-500 @enderror" 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="username" id="username" value="{{ old('username') }}" 
                                    class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all @error('username') border-red-500 @enderror" 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email') }}" 
                                    class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all @error('email') border-red-500 @enderror" 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="nomor_telepon" id="nomor_telepon" value="{{ old('nomor_telepon') }}" 
                                    class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all @error('nomor_telepon') border-red-500 @enderror" 
                    ...
                    <div class="space-y-5">
                        <div class="flex items-center space-x-2 pb-3 border-b border-gray-200">
                            ...
                            <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wide">Keamanan</h4>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password" id="password" 
                                    class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all @error('password') border-red-500 @enderror" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="role_id" id="role_id" 
                                        ...
                                        class="block w-full px-3 py-2.5 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all appearance-none bg-white @error('role_id') border-red-500 @enderror" required>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="status" id="status" 
                                        style="-webkit-appearance: none; -moz-appearance: none;"
                                        class="block w-full px-3 py-2.5 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all appearance-none bg-white @error('status') border-red-500 @enderror" required>
